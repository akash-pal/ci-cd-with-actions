[![React App CI](https://github.com/akash-pal/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/akash-pal/ci-cd-with-actions/actions/workflows/ci.yml)
